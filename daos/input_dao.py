...
class InputDao:
    ...
    def get_inputs(self, player_name: str) -> InputData:
        query = '''
            SELECT RAYCAST_0, RAYCAST_30, RAYCAST_45, RAYCAST_315, RAYCAST_330, COLLECT_ANGLE, COLLECT_LENGTH, GRAVITY_DIR, SPEED, ON_GROUND_TOP, ON_GROUND_BOT, SWITCH_GRAVITY
            FROM INPUTS
            WHERE player_name = %s 
        '''
        params = (player_name,)
